...
- Move the job queue and rate limiter to Redis for multi-replica support
- Support additional languages (Java, others)
- `PATCH` endpoints for editing problems/test cases without delete-and-recreate
- Docker Compose for one-command local setup (API + Postgres together)
